...
public class Vec3d
{
   ...
   public Vec3d mul(double scalar) {
     ...
     * @return current vector
     */
    public Vec3d scale(final float scale)
    {
        this.x*=scale;
        this.y*=scale;
        this.z*=scale;
     ...
     * @return current vector
     */
    public Vec3d scale(final float scalex,final float scaley,final float scalez)
    {
        this.x*=scalex;
        this.y*=scaley;
        this.z*=scalez;
     ...
     * @return current vector
     */
    public Vec3d setScale(final float scale,final Vec3d that)
    {
        this.x=scale*that.x;
        this.y=scale*that.y;
        this.z=scale*that.z;
     ...
     * @return current vector
     */
    public Vec3d addScale(final float scale,final Vec3d that)
    {
        this.x+=scale*that.x;
        this.y+=scale*that.y;
        this.z+=scale*that.z;
     ...
     * @return current vector
     */
    public Vec3d setMatMultiply(final float[] mat,final Vec3d v)
    {
     ...
     * @return current vector
     */
    public Vec3d setTransposeMatMultiply(final float[] mat,final Vec3d v)
    {
