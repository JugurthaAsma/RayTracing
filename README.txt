...
* Run the program
    Open a terminal in this folder and execute the command :
        ...
        - 'make run' to run the program with default arguments (resolution: 1920x1080, distance: 1.0D, depth: 3 recursion).
    ...
    Each execution will generate three images (three different scenes) in the 'images' folder (I let an example of 1920x1080 resolution for this deposit).
...
* Project structure :
    ...
    └── RayTracing
        ...
        │   ├── Scene_1_1920x1080.tga
        │   ├── Scene_2_1920x1080.tga
        │   └── Scene_3_1920x1080.tga
        └── src                         
